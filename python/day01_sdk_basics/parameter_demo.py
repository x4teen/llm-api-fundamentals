...
response = client.messages.create(
    ...
    max_tokens=512,
    temperature=0.0,     # 0.0 = deterministic/precise, 1.0 = creative/varied
    top_k=40,            # only consider the 40 most likely next tokens
    system="You are a helpful IT assistant.",
    messages=[{"role": "user", "content": "Classify this ticket as P1/P2/P3: server is down"}]
)
